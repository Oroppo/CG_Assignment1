...
Application::Application() :
	...
	_isRunning(false),
	_isEditor(true),
	_windowTitle("INFR - 2350U Assignment 1"),
...
int Application::KeyPressed() {

	if (InputEngine::IsKeyDown(GLFW_KEY_1)) {
		_lastKey = 1;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_2)) {
		_lastKey = 2;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_3)) {
		_lastKey = 3;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_4)) {
		_lastKey = 4;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_5)) {
		_lastKey = 5;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_6)) {
		_lastKey = 6;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_7)) {
		_lastKey = 7;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_8)) {
		_lastKey = 8;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_9)) {
		_lastKey = 9;
	}
	else if (InputEngine::IsKeyDown(GLFW_KEY_0)) {
		_lastKey = 0;
	}
	return _lastKey;
}
...
//void Application::ChangeLut() {
//	if (KeyPressed() == 8) {
//		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/RedPlanet.CUBE");
//		CurrentScene()->SetColorLUT(lut);
//	}
//	if (KeyPressed() == 9) {
//		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/BluePlanet.CUBE");
//		CurrentScene()->SetColorLUT(lut);
//	}
//	if (KeyPressed() == 0) {
//		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/DarkDimension.CUBE");
//		CurrentScene()->SetColorLUT(lut);
//	}
//}
